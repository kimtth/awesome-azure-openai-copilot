...
Microsoft Azure OpenAI & Copilot ecosystem: services, frameworks, agent platforms, evaluation tooling, and reference architectures for secure, production-grade generative and agentic AI applications.
...
- 🏆`github organizations`: 🌐 Azure | 🏬 Azure-samples | 🏛️ Microsoft | 👥 MSUSAzureAccelerators
...
- [Power Apps AI Copilot](https://learn.microsoft.com/en-us/power-apps/maker/canvas-apps/ai-overview) - Power Apps AI Copilot.
- [Power Automate Copilot](https://learn.microsoft.com/en-us/power-automate/get-started-with-copilot) - Power Automate cloud flows.
- [PowerBI Copilot](https://learn.microsoft.com/en-us/power-bi/create-reports/copilot-introduction) - Copilot features Power BI.
- [Process Mining ingestion](https://learn.microsoft.com/en-us/power-automate/process-mining-copilot-in-ingestion) - Power Automate Process Mining ingestion.
...
### Agents
- 🏛️[AI Agents for Beginners - A Course](https://github.com/microsoft/ai-agents-for-beginners) - Ten-lesson introduction to building AI agents.
...
- [Agents in Power Platform](https://www.microsoft.com/en-us/power-platform/blog/2024/11/19/redefine-development-ai-first-innovation-with-agents-and-microsoft-copilot-in-power-platform/) - Redefine development with AI-first innovation.
...
- [Microsoft 365 Agents SDK](https://devblogs.microsoft.com/microsoft365dev/introducing-the-microsoft-365-agents-sdk/) - The evolution of the Bot Framework.
...
- [Community contributed samples for the Microsoft 365 Copilot](https://github.com/pnp/copilot-pro-dev-samples) - Community samples for Microsoft 365 Copilot.
...
- [Copilot System Overview (video)](https://www.youtube.com/watch?v=E5g20qmeKpg) - Architecture explanation video.
...
- [Azure AI Search Blog](https://azure.microsoft.com/en-us/blog/product/azure-ai-search) - Official Blog.
- [Azure AI Search Documentation](https://learn.microsoft.com/en-us/azure/search/) - Official Documentation.
...
- 🏬[Azure AI Search Samples](https://github.com/Azure-Samples/azureai-samples) - Official Sample Codes.
...
- 🏛️[RAG-Knowledge](https://github.com/microsoft/RAG-Knowledge) - Sample code for Data Preprocessing, Chunking, Index Design, Query Optimization.
...
- 🌐[Vector Search Sample Code](https://github.com/Azure/azure-search-vector-samples) - Vector Search Sample Code.
...
- [Azure AI Foundry Agent Service](https://techcommunity.microsoft.com/blog/azure-ai-services-blog/announcing-general-availability-of-azure-ai-foundry-agent-service/4414352) - Azure AI Foundry Agent Service.
- [Azure AI Foundry Fine Tuning](https://techcommunity.microsoft.com/blog/aiplatformblog/what%E2%80%99s-new-in-azure-ai-foundry-fine-tuning/4413873) - Azure AI Foundry Fine Tuning.
...
- [Responses API](https://devblogs.microsoft.com/foundry/introducing-new-tools-and-features-in-the-responses-api-in-azure-ai-foundry/) - Responses API in Azure AI Foundry.
- [Weights & Biases with Azure](https://aka.ms/WBFineTuningPartnership) - Weights & Biases with Azure.
...
- [Data Science Toolkit](https://www.ds-toolkit.com/) - 🏆Data Science Toolkit.
- [GraphRAG (by Microsoft)](https://alphaxiv.org/abs/2404.16130) - RAG with a graph-based approach to efficiently answer both specific and broad questions over large text corpora1.
...
- [PromptWizard](https://www.microsoft.com/en-us/research/blog/promptwizard-the-future-of-prompt-optimization-through-feedback-driven-self-evolving-prompts/) - The future of prompt optimization through feedback-driven self-evolving prompts.
...
- 👥[Azure-Cognitive-Search-Azure-OpenAI-Accelerator](https://github.com/MSUSAzureAccelerators/Azure-Cognitive-Search-Azure-OpenAI-Accelerator) - Azure Cognitive Search + Azure OpenAI Accelerator.
...
- 🌐[Azure OpenAI samples](https://github.com/Azure/azure-openai-samples) - Azure OpenAI samples.
...
- 🏬[Azure-Samples](https://github.com/Azure-Samples) - Azure-Samples.
- 🏬[Azure-Samples Accelerators](https://github.com/orgs/Azure-samples/repositories?q=accelerator+sort%3Astars) - Community sample accelerators.
- 🏬[Azure-samples: Accelerator Collection](https://github.com/orgs/Azure-samples/repositories?q=quick+sort%3Astars) - Accelerator Collection.
...
- 🏬[Enterprise Logging](https://github.com/Azure-Samples/openai-python-enterprise-logging) - Enterprise Logging.
...
- 🌐[Setting up Azure OpenAI with Azure API Management](https://github.com/Azure/enterprise-azureai).
...
- [AI Platform Blog](https://techcommunity.microsoft.com/t5/ai-ai-platform-blog/bg-p/AIPlatformBlog) - AI Platform Blog.
...
- [Azure AI Services Landing Zone](https://github.com/FreddyAyala/AzureAIServicesLandingZone) - Azure AI Services Landing Zone.
- [Azure Command Companion](https://techcommunity.microsoft.com/t5/analytics-on-azure-blog/azure-command-companion/ba-p/4005044) - Harnessing the Power of OpenAI GPT-3.5 Turbo for Azure CLI Command Generation.
- [Azure OpenAI and Call Center Modernization](https://techcommunity.microsoft.com/t5/azure-architecture-blog/azure-openai-and-call-center-modernization/ba-p/4107070) - Azure OpenAI and Call Center Modernization.
- [Azure OpenAI Best Practices Insights from Customer Journeys](https://techcommunity.microsoft.com/t5/ai-azure-ai-services-blog/azure-openai-best-practices-insights-from-customer-journeys/ba-p/4166943) - LLMLingua, Skeleton Of Thought.
...
- [Azure OpenAI Landing Zone reference architecture](https://techcommunity.microsoft.com/t5/azure-architecture-blog/azure-openai-landing-zone-reference-architecture/ba-p/3882102) - Azure AI Services Landing Zone.
- [Baseline Agentic AI Systems Architecture](https://techcommunity.microsoft.com/t5/ai-machine-learning-blog/baseline-agentic-ai-systems-architecture/ba-p/4207137) - Baseline Agentic AI Systems Architecture.
- [Baseline OpenAI end-to-end chat reference architecture](https://learn.microsoft.com/en-us/azure/architecture/ai-ml/architecture/baseline-openai-e2e-chat) - Baseline OpenAI end-to-end chat reference architecture.
- [Build language model pipelines with memory](https://learn.microsoft.com/en-us/azure/architecture/ai-ml/openai/guide/language-model-pipelines) - Build language model pipelines with memory.
- [Chat with your Azure DevOps data](https://techcommunity.microsoft.com/t5/fasttrack-for-azure/chat-with-your-azure-devops-data/ba-p/4017784) - Chat with your Azure DevOps data.
...
- [Designing and developing a RAG solution](https://learn.microsoft.com/en-us/azure/architecture/ai-ml/guide/rag/rag-solution-design-and-evaluation-guide) - Designing and developing a RAG solution.
- [Grounding LLMs](https://techcommunity.microsoft.com/t5/fasttrack-for-azure/grounding-llms/ba-p/3843857) - Retrieval-Augmented Generation (RAG).
...
- [NL to SQL Architecture Alternative](https://techcommunity.microsoft.com/t5/azure-architecture-blog/nl-to-sql-architecture-alternatives/ba-p/4136387) - NL to SQL Architecture Alternative.
...
- [Security Best Practices for GenAI Applications (OpenAI) in Azure](https://techcommunity.microsoft.com/t5/azure-architecture-blog/security-best-practices-for-genai-applications-openai-in-azure/ba-p/4027885) - Security Best Practices for GenAI Applications (OpenAI) in Azure.
